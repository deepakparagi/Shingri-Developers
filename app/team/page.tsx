    ...
    return (
        <main className="bg-monte-white min-h-screen">
            ...
            <section className="py-24 px-4 md:px-8 lg:px-24">
                <div className="flex flex-col lg:flex-row items-center gap-16">
                    <motion.div
                        ...
                        transition={{ duration: 0.8 }}
                        className="w-full lg:w-1/2 relative h-[500px] lg:h-[700px] rounded-2xl overflow-hidden shadow-2xl"
                    >
                        <Image
                    ...
                    >
                        <span className="text-sm uppercase tracking-widest text-gray-500 mb-2 block">Managing Director</span>
                        <h2 className="text-5xl font-serif text-monte-black mb-6">Aditya Shingri</h2>
            ...
            <section className="py-24 px-4 md:px-8 lg:px-24 bg-gray-50">
                <h2 className="text-4xl font-serif text-center text-monte-black mb-16">Leadership Team</h2>
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12">
                    {teamMembers.map((member, index) => (
                        ...
                        >
                            <div className="relative h-80 w-full mb-6 rounded-xl overflow-hidden grayscale group-hover:grayscale-0 transition-all duration-500">
                                <Image
                                    src={member.image}
                                    alt={member.name}
                                    fill
                            ...
                            <h3 className="text-2xl font-serif text-monte-black mb-1">{member.name}</h3>
                            <p className="text-sm uppercase tracking-widest text-monte-gold mb-4">{member.role}</p>
